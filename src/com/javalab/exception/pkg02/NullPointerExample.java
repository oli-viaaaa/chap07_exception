...
public class NullPointerExample {
	...
	public static void main(String[] args) {
		...
		try {
			Student stu = null; // 클래스 변수 선언만 해놓음 초기화 안함
			stu = new Student(); // 빈 객체 생성하면 예외 발생 안함.
			System.out.println(stu.a); // 예외 발생하는 부분(객체 생성후 초기화
		}catch (NullPointerException e) { // jvm이 던질 것 같은 오류를 적어놔야함
